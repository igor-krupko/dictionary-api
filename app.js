...
const initialWords = [
  { id: uuidv4(), valueEn: 'I', valueRu: 'Я', comments: 'Когда говорят про себя', status: '0' },
  { id: uuidv4(), valueEn: 'Love', valueRu: 'Тебя', comments: 'Другой человек, на которого указываешь', status: '1' },
  { id: uuidv4(), valueEn: 'You', valueRu: 'Люблю', comments: 'Когда один человек испытывает чувства к другому человеку', status: '2' }
];
